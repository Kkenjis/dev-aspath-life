...
/* ══════════ 7 固定ページを直す ══════════ */
{
  ...
  box(s, 0.65, 5.35, 11.95, 1.35, "この6つの中身は、第15部にすべて書いてあります",
    "どのファイルを開くか、文章の探し方、失敗したときの戻し方まで、実作業の手順として書き起こしました。レクチャーもこの部を教材に行います。なお「ASPATHについて」だけは本文をWordPress側に移してあるため、管理画面から直せます（別冊『★山口様向け_ASPATHについて_文章の直し方』）。", "ok");
  s.addNotes("道Bの全体像。実作業は第15部に集約した。");
}
