...
/* AIに開発者の仕事をさせる */
{
  ...
  // 貼り付け用の型は7行ある。枠を低くすると最終行が下の枠に隠れるため、高さは1.9以上を保つこと。
  B.code(s,0.65,4.5,11.97,1.9,"困ったときに、そのまま貼れる型",
...
【いつから】いつ気づいたか、直前に何をしたか`,11);
  B.box(s,0.65,6.5,11.97,0.66,"「直前に何をしたか」を必ず書いてください。原因の8割はここにあります。","","warn");
