...
function aspath_seo_descriptions() {{
  return array(
    'column'    => 'パーキンソン病の症状や運動について、鹿児島のパーキンソン病専門トレーニングスタジオASPATH（アスパス）が専門家の視点でお伝えするコラムです。ご自宅でできる運動もご紹介しています。',
    ...
    'faq'       => '初回体験・料金・トレーニング内容について、よくいただくご質問にお答えします。パーキンソン病のご不安にも、専門スタッフがお応えします。',
