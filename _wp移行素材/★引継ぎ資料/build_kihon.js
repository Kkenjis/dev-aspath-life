...

{
  ...
  // 高さ4.04だとスライド下端(7.5in)を超えていたため、3.90に縮小
...

{
  ...
  note(s, 0.62, 4.95, 12.05, 1.15,
    "迷ったら「スパム」を選んでください",
    "承認すると、パーキンソン病専門サイトにカジノへのリンクが載ってしまいます。間違えて本物をスパムにしても、あとから戻せます。", "warn");
  note(s, 0.62, 6.22, 12.05, 0.85,
    "承認したコメントは、長いものだけ自動で折りたたまれ「もっと見る」で開きます（2026年9月〜）",
    "文字も記事本文より少し小さくしてあります。次の方が書き込みやすいようにするための調整で、山口様の操作は不要です。", "info");
...
// ══════════════════════════════════════════════
{
  ...
  const trouble = [
    { q: "直したのに画面が変わらない", a: "左メニュー「Super Page Cache」→ 赤い「Purge Cache」を押してから、Ctrl キーを押しながら F5 で再読み込みしてください。" },
